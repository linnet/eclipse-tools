...
public abstract class AbstractWizardProjectPathPage extends WizardPage {
    ...
    // The last location specified as export or import directory
    ...
    protected Listener locationModifyListener = new Listener() {
    ...
    protected void createBrowseButton(Composite projectGroup, Font dialogFont) {
        ...
        browseButton.setText(Messages.getString("AbstractWizardProjectPathPage.browse")); //$NON-NLS-1$
    ...
    protected boolean validatePath(Text pathField, boolean allowEmpty) {
        ...
        if (!(allowEmpty && pathFieldContents.equals(""))) { //$NON-NLS-1$
            if (pathFieldContents.equals("")) { //$NON-NLS-1$
                setErrorMessage(null);
                setMessage(Messages.getString("AbstractWizardProjectPathPage.pathEmpty")); //$NON-NLS-1$
            ...
            if (!path.isValidPath(pathFieldContents)) {
                setErrorMessage(Messages.getString("AbstractWizardProjectPathPage.invalidPath")); //$NON-NLS-1$
            ...
            if (!dir.isDirectory()) {
                setErrorMessage(Messages.getString("AbstractWizardProjectPathPage.notADirectoryPath")); //$NON-NLS-1$
    ...
    protected String browseDirectory(Text pathField, String directory) {
        ...
        dialog.setMessage(Messages.getString("AbstractWizardProjectPathPage.directory")); //$NON-NLS-1$
    ...
    private void createExplanationLabel(Composite group, Font dialogFont, String messageId) {
        ...
        explanationLabel.setText(Messages.getString(messageId)); //$NON-NLS-1$
